# Backlog de sprint — Sprint 0

**Durée :** Semaines 36–38 (mardi 1 sept. – 20 sept. 2026)\
**Objectif du sprint :** Cadrer le projet, constituer l'équipe, poser les bases techniques et documentaires, et préparer le premier rendez-vous client.

## Tâches

| ID | Tâche | Description | Responsable | Estimation | Statut |
|---|---|---|---|---|---|
| T-01 | Constitution de l'équipe | Répartir les rôles (Product Owner, Scrum Master, développeurs) | Équipe | 0.5h | Fait |
...
| [T-09](https://github.com/PPS-SAE-S5/PPS-COMP-2027/blob/main/Documentation/Sprint%200/Documentation%20Chiffrage.md) | Chiffrage du projet | Estimer la charge globale | Équipe | 2h | À faire |
...
## Résumé du fait (pour le Sprint 0)

- [x] Équipe constituée avec rôles définis
- [ ] Repository GitHub opérationnel avec README, board, backlog produit et backlog sprint versionnés
- [x] RDV client planifié
- [x] 1er RDV client fait
- [ ] Stack technique choisie et documentée
- [ ] Chiffrage du projet disponible
- [ ] Backlog produit v0 validé en équipe

</br>

## Notes de réunion à archiver

[Compte rendu de la réunion 1](https://github.com/AdamLab5/PPS-COMP-2027/blob/main/Documentation/Sprint%200/reunion%201%20review.md)
